...
- UI and browser-based automation for systems without stable APIs
- Integration of databases, APIs, and third-party platforms
...
- Implementing **JavaScript** logic for frontend transformers and workflow orchestration
- Automating web-based systems using **Playwright** and **Selenium**
- Working with **REST APIs** and asynchronous data flows
...
- Designing systems that are observable, auditable, and maintainable
- Applying engineering rigor to analytics and operations workflows
